        ...
        <main class="mainbody centeredsection">
            ...
            <div class="basicform">
                <form method="POST">
                    ...
                    <label for="permissions>max_size>hot" title="This is the maximum number of plates that users can have in all of their hot-lists combined.">Max Hot-List Entries:</label> <input type="number" name="permissions>max_size>hot" id="permissions>max_size>hot" placeholder="10" step="1" value="<?php echo $manifest_config["permissions"]["max_size"]["hot"]; ?>"><br>
                    <label for="permissions>max_size>ignore" title="This is the maximum number of plates that users can have in all of their ignore-lists combined.">Max Ignore-List Entries:</label> <input type="number" name="permissions>max_size>ignore" id="permissions>max_size>ignore" placeholder="10" step="1" value="<?php echo $manifest_config["permissions"]["max_size"]["ignore"]; ?>"><br>

                    <label for="permissions>max_count>hot" title="This is the maximum number of hot-lists that a user can have associated with their account.">Max Hot-List Count:</label> <input type="number" name="permissions>max_count>hot" id="permissions>max_count>hot" placeholder="5" step="1" value="<?php echo $manifest_config["permissions"]["max_count"]["hot"]; ?>"><br>
                    <label for="permissions>max_count>ignore" title="This is the maximum number of ignore-lists that a user can have associated with their account.">Max Ignore-List Count:</label> <input type="number" name="permissions>max_count>ignore" id="permissions>max_count>ignore" placeholder="5" step="1" value="<?php echo $manifest_config["permissions"]["max_count"]["ignore"]; ?>"><br>
